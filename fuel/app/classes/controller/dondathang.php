...
class Controller_dondathang extends Controller_Base
{
    ...
    {
        $this->template->title   = Lang::get('title_dondathang');
        $this->template->content = View::forge('dondathang/index');
    }
    ...
    public function action_add()
    {
        ...
        try {
            ...
            if (Input::method() == 'POST') {
                ...
                $order_type = Constant::ORDER_TYPE_ORDER;
    ...
    public function action_excel()
    {
    	if (Input::method() == 'POST') {
    		...
    		$objPHPExcel = \PHPExcel_IOFactory::load($tpl_dir . 'tpl_don_dat_hang.xls');
    		// Set active sheet
    		...
    		// Rename worksheet
    		$activeSheet->setTitle('dondathang');
    		// Set active sheet index to the first sheet, so Excel opens this as the first sheet
    		$objPHPExcel->setActiveSheetIndex(0);
    
    		$timestamp = time();
    		$fileName = "don_dat_hang_".$timestamp.".xls";

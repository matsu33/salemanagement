...
class Controller_Phieugiaohang extends Controller_Base
{
    ...
    {
        $this->template->title   = Lang::get('title_phieugiaohang');
        $this->template->content = View::forge('phieugiaohang/index');
    }
    ...
    public function action_add()
    {
        ...
        try {
            ...
            if (Input::method() == 'POST') {
                ...
                $order_type = Constant::ORDER_TYPE_TRANSPORT;
    ...
    public function action_save()
    {
        ...
        $this->template->content = View::forge('phieugiaohang/save', $data);
    }
    ...
    public function action_print()
    {
        ...
        $this->template->content = View::forge('phieugiaohang/print', $data);
    }
    ...
    public function action_update()
    {
        ...
        $this->template->content = View::forge('phieugiaohang/update', $data);
    }
    ...
    public function action_delete()
    {
        ...
        $this->template->content = View::forge('phieugiaohang/delete', $data);
    }
    ...
    public function action_excel()
    {
    	if (Input::method() == 'POST') {
    		...
    		$objPHPExcel = \PHPExcel_IOFactory::load($tpl_dir . 'tpl_phieu_giao_hang.xls');
    		// Set active sheet
    		...
    		// Rename worksheet
    		$activeSheet->setTitle('phieugiaohang');
    		// Set active sheet index to the first sheet, so Excel opens this as the first sheet
    		$objPHPExcel->setActiveSheetIndex(0);
    
    		$timestamp = time();
    		$fileName = "phieu_giao_hang_".$timestamp.".xls";

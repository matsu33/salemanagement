<div class="modal fade" id="product_group_modal"><!-- data-backdrop="static" -->
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-body">
				<?php echo Form::open(array("class"=>"", 'id' => 'frm_product_group_add')); ?>
					...
					<button type="submit" class="btn btn-success" id="btn_product_group_add">
					<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;&nbsp;Thêm hàng hóa</button>
					<?php echo Form::close(); ?>
					<hr>
					<table class="table table-condensed table-hover table-striped dataTable no-footer" id="table_product_group">
						<thead>
							<tr>
								<th>Hình ảnh</th>
								<th>Hàng hóa</th>
			...
			<div class="modal-footer">
				...
				<a class="btn btn-primary" href="#" data-dismiss="modal">Đồng ý</a>
			</div>
		</div>
	</div>
</div>

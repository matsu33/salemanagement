	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-header">
		    	...
		    	<h4 class="modal-title">Thêm sản phẩm vào đơn đặt hàng</h4>
		    </div>
			<div class="modal-body">
					...
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-4" >Giá bán sỉ</label>
						<div class="col-sm-6">
							<input maxlength="10" name="wholesales_price" type="text" class="input_price form-control" readonly value="0">
						</div>
						<div class="radio col-sm-2">
						      <label><input type="radio" name="price_type" value="0" checked="checked"></label>
						</div>
					</div>
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-4" >Giá bán lẻ</label>
						<div class="col-sm-6">
							<input maxlength="10" name="retail_price" type="text" class="input_price form-control" readonly value="0">
						</div>
						<div class="radio col-sm-2">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary btn_get_price" href="#">Lấy giá</button>
